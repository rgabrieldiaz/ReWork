        ...
        <div className="space-y-8 animate-in fade-in duration-500 pb-16">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
                    <div className="max-w-2xl">
                        <h1 className="text-3xl font-bold tracking-tight mb-3 flex items-center gap-3">
                            {t.colaboradores.title} <Users className="text-accent-teal" />
                        </h1>
            ...
            <div className="relative max-w-md">
                ...
                <input
                    ...
                    className="w-full bg-card border border-border-subtle rounded-2xl pl-12 pr-4 py-3.5 text-foreground focus:outline-none focus:border-accent-teal/50 transition-colors"
                />
            </div>
