                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full">
                    ...
                    <div className="relative">
                        <select
                            ...
                            className="pl-4 pr-10 py-2 bg-[#0a0a0a] border border-white/10 rounded-xl text-sm focus:outline-none focus:border-accent-teal appearance-none cursor-pointer w-full sm:w-min whitespace-nowrap text-white"
                        >
        ...
        <div className={`bg-[#0a0a0a] rounded-2xl border ${isFinished || isCancelled ? 'border-neutral-800 opacity-70' : 'border-white/5 hover:border-accent-teal/30'} overflow-hidden group transition-all flex flex-col shadow-lg`}>
            <div className={`h-48 ${isFinished || isCancelled ? 'bg-neutral-900/50' : 'bg-neutral-900'} border-b border-white/5 flex items-center relative justify-center text-7xl flex-shrink-0 group-hover:scale-[1.02] transition-transform duration-500`}>
                ...
                <div className="absolute top-3 left-3 right-3 flex justify-between items-start pointer-events-none">
                    <div className="bg-black/80 backdrop-blur-md px-2.5 py-1 rounded-lg border border-white/10 shadow-sm flex items-center">
                        <span className="text-xs font-bold text-white tracking-wide">Base: {item.base_price} {currency}</span>
                    </div>
                    {isCancelled ? (
