...
export function Sidebar({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
    ...
    const navItems = [
        ...
        { name: "Squad Goals", href: "/squad-goals", icon: Target },
    ...
    return (
        <>
            ...
            <aside className={`
                fixed top-0 left-0 z-50 h-screen w-64 bg-deep-navy border-r border-border-glass flex flex-col transition-transform duration-300 ease-in-out
