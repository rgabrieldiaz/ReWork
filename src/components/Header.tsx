...
export function Header() {
    ...
    return (
        <header className="h-20 flex items-center justify-between px-8 border-b border-border-glass sticky top-0 bg-deep-navy/80 backdrop-blur-md z-40">
            {connected ? (
                ...
                <div className="flex items-center gap-8">
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-2">
                            <p className="text-xl font-bold">
                                {balanceLoading || profileLoading ? <span className="animate-pulse bg-slate-800 rounded w-20 h-6 block mt-1"></span> : totalNetWorth}
                            </p>
